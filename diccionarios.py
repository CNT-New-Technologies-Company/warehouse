orden_cols = ['Pozo', 'Etapa', 'Fecha Inicio', 'Fecha Fin', 'Hora Inicio', 'Hora Fin', 'desde',
       'hasta', 'Notas', 'Tipo Agujero', 'Actividad', 'Sub Actividad',
       'Descripción Actividad', 'Condicionante', 'Color', 'Color Est', 'Hora',
       'ROT M', 'DESL M', 'ROT MIN', 'DESL MIN', 'CIRC MIN', 'H BBA', 'ROP',
       'Rebaja Cem', 'TipoTr', 'VelTR', 'Viajes M', 'Vel', 'Lingadas',
       'Long Ling', 'TC', 'Tipo BHA', 'Profundidad Conexión', 'Pre',
       'Pre Survey', 'Pre Comando', 'Repaso', 'Conexión', 'Pos', 'Pos Comando',
       'Pos Survey', 'Orienta', 'Otros', 'Reducida', 'Baches', 'ProcMPD',
       'Duración', 'Inc']
